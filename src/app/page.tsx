...
const experienceHighlights = [
  {
    ...
    period: '2025 — Present',
    location: 'Egypt',
    highlight: 'Architecting zero-to-one infrastructure and defining the core technical vision for next-generation digital solutions.',
  ...
  },
  {
    ...
    highlight: 'Orchestrating robust, high-throughput fintech payment infrastructure and mission-critical financial systems at massive scale.',
  ...
  },
  {
    ...
    highlight: 'Architected the foundational IAM Control Plane Proxy-Router. Achieved sub-3ms P99 latency and 100% multi-region deployment automation.',
  ...
  },
  {
    ...
    highlight: 'Drove hyperscale NLP product expansion globally from 1 to 7 concurrent platforms in a single year. Executed transitions across Data Science and Engineering.',
