        ...
        <div className="border-t border-white/10 pt-10 pb-16">
          <ContainerInner>
            <div className="flex flex-col items-center gap-6">
              ...
              {/* Nav + Copyright */}
              <div className="flex flex-col items-center gap-6 md:flex-row md:justify-between md:w-full">
                <div className="flex flex-wrap justify-center gap-x-6 gap-y-1 text-sm font-medium text-zinc-400">
